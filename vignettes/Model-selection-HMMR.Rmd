---
title: "Model-selection-HMMR"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Model-selection-HMMR}
...
In this package, it is possible to select an HMMR model based on information criteria such as 
**BIC**, **AIC** and **ICL**.
