---
title: "Model-selection-RHLP"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Model-selection-RHLP}
...
In this package, it is possible to select an RHLP model based on information criteria such as 
**BIC**, **AIC** and **ICL**.
