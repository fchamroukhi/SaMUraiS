---
title: "Model-selection-MHMMR"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Model-selection-MHMMR}
...
In this package, it is possible to select models based on information criteria such as 
**BIC**, **AIC** and **ICL**.
...
Let's select a MHMMR model for the following time series $Y$:
